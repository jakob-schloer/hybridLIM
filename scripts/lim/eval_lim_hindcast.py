...
def hindcast_evaluation(
    lim_hindcast: xr.DataArray,
    ...
    Args:
        ...
        add_eof_noise (bool): Whether to add randomly generated higher order EOFs to the hindcast

    Returns:
        tuple[xr.Dataset, xr.Dataset, xr.Dataset]: Grid scores, time scores, nino indices
    """
    ...
    for lag in lag_arr:
        ...
        x_hindcast = eval.latent_frcst_to_grid(z, target_time, combined_eof, normalizers, extended_eof=extended_eof)
